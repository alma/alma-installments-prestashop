...
- Feature/ecom 1704 ps update dev component fixer
- fix ps account in dev mode
- PS account first alma activation
- [devx] Fix local lint:fix
- Fix of minicart for insurance after updateCart
- add libraries for ps account
- Handle ps account & PS 1.6
- render always ps account form
- REVIEW 12 : refacto + settings helper test + phpcbf
- REVIEW 11 :  ps unit apihelpertest
- REVIEW 10 : CartHelperTest
- REVIEW 9 : add customer fields helper tests
- REVIEW 8  ps unit currencyhelpertest
- REVIEW 7 : ps unit customerhelpertest
- REVIEW 6 : add carrier helper test
- REVIEW 2 :ps unit addresshelpertest
- [DEX-807]  Update pre commit file
- [DEX-811] Add CODEOWNERS file
- REVIEW 5 :Add media helper test
- REVIEW 1 : add context helper tests
- REVIEW 4 :ps unit orderstatehelpertest
- REVIEW 3 :ps unit translationhelpertest
- [DEX-810] Use taskfile
- [IPLN] Fix handle insurance mini cart module pscartdropdown
- fix quantity if quantity equal zero
- Add factory builder
- [ODP] Fix remove id in type of script of insurance
- Send ttc price for insurance amount
- Check why cart id is not sent with subscription in prod
- Fix display insurance widget if id product attribute
- Ps fr translation for all wording in bo
- unit planhelpertest
- Unit toolshelpertest
- Configurationhelpertest
- [insurance] Fix change order state in the orders page bo
- Fix change order state in the orders page bo
- Feature insurance
- Fix CmsReference if productAttributeId is null
- Fix load event button for remove insurance in cart at the end
- Fix order warning UI
- [insurance] Fix isrefunded param sent to ifram
- Fix insurance for ODP
- Fix handle quantity if input id isn't quantity_wanted
- [insurance] Register hooks on update module
- [insurance] Store reference and send it to IFrame
- Fix refund button display
- [develop] Feature/ecom 1522/refactor main run function
- [develop] Refactor functions to get buttons title and description + add tests
- [develop] add tests getDateFormat
- [develop] add tests getFrenchDateFormat
- [develop] Cartdata test get cart exclusions
